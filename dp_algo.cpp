...
/* Takes in a filename and outputs the bitmap and the image size*/
...
/* Takes in the bitmap and outputs the time series */
...
/* Overlays the time series on the bitmap */
