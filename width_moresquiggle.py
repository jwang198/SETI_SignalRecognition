...
def main():
    ...
    paths = []
    parseData("./DATA/moresquiggle_ts.txt", paths)
    count = 0

    width_vector = np.zeros(219)
    for fn in os.listdir("../MoreSquiggles/"):
        print(fn)
        #print(count)
    ...
    outputFile = open("width_moresquiggle.txt",'w')
